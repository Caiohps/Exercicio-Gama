import backgroundTwo from '../../../assets/images/background/background2.png';
...
let HomeSectionTwo = `
<section id="darthvader" class="section background--two" style="background-image: url(${backgroundTwo})">
